...
- dom nodes dont exist until render, so we need ref to target those nodes once theyve been created
- dont use ref on elements that need to be re-rendered, useState for that
## Background
