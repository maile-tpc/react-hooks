...
- useRef vars wont re render the component
- Lazy initializing with useState
- can assign JSON.serialize and JSON.deserialize as vars that still function the same. seems almost like giving them custom, more readable names
